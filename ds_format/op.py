...
def dims(d, var=None, *value, full=False, size=False):
	...
	arguments: {{
		*d*: "Dataset (`dict`)."
		*value*: "A list of dimensions (`list` of `str`) or `None`. If supplied, set variable dimensions, otherwise get dataset or variable dimensions. If `None`, remove dimensions (will be set to autogenerated names on write)."
	}}
	options: {{
